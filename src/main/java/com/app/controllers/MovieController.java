...
//	@ResponseBody
	...
	{
		System.out.println("Get all movies api called");
		try
		{
	...
	@GetMapping("/getMovie")
	public ResponseEntity<Movie> getOneMovie()
	{
		System.out.println("Movie api hit");
		Movie movie=new Movie();
		movie.setId(145);
		movie.setMainGenre("IN");
		movie.setDuration(9090909);
		movie.setMainProduction("Comedy");
